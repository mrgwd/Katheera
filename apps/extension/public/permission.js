...
const STR = {
  ...
  ar: {
    dir: "rtl",
    docTitle: "كثيرة | إذن الميكروفون",
    imgAlt: "إذن ميكروفون كثيرة",
    title: "مطلوب الوصول إلى الميكروفون",
    body: 'تحتاج كثيرة إلى الوصول للميكروفون. يرجى الضغط على الزر أدناه ثم الضغط على "<strong>السماح أثناء زيارة الموقع</strong>" في نافذة المتصفح',
    button: "منح الإذن",
    ...
    denied: "تم رفض الإذن. حاول مجددًا واضغط 'سماح'.",
  },
};
