import { cva } from "@workspace/lib/utils";

// Server-safe variant definition (no "use client" here by design —
// buttonVariants() is called from Server Components via locale-aware Links).
// The interactive <Button> lives in ./button.tsx and re-exports this.
