  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        // Thumb travel is physical (translate-x): the flex row mirrors in RTL
        // (resting the thumb right when off) but the checked push does not, so
        // it must be negated under rtl — otherwise it exits the track.
